...
`mecha_cinematic_keyart`는 성인 애니풍 얼굴과 고밀도 하드서피스 메카 재질을
결합한다. 단독 컷에서는 시네마틱 공간감과 전신 영웅 구도를 허용하고, 기준 시트와
비교 초상에서는 고정 배치를 유지한 채 얼굴·장갑·조명의 질감만 동일하게 이어간다.
장갑 디테일을 높이더라도 선택한 폼의 장갑 면적이나 실루엣은 바꾸지 않으며 글자·
번호·로고·의사 문자를 장갑과 배경에 만들지 않는다.
