...
function StyleSample({style}){
 ...
 return h('figure',{class:'studio-style-sample',id:'style-sample','aria-labelledby':'style-sample-caption'},
  ...
  h('a',{href:A.imgURL(file),target:'_blank',rel:'noopener','aria-label':W('prompt.style.sample.open',{style:title})},
   h('img',{src:A.imgURL(file),alt:W('prompt.style.sample.alt',{style:title}),
