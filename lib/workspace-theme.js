...
(function () {
  ...
  var themeColors = { midnight: '#101925', 'daylight': '#edf1f5', blossom: '#f7f8fa', moss: '#121a14', plum: '#1c141b',
    sand: '#f3efe4', deep: '#0d1d25', ember: '#1d1710' };
  var viewportFrame = 0;
  ...
  function normalize(key, value) {
    return key === 'theme' ? (themeColors[value] ? value : 'midnight')
