...
(function (root) {
  ...
  var WORDS = {
    ...
    'home.run.note': '세 장을 뽑아 일곱 판을 이어 싸운다. 판 사이에 진화나 회복을 고르고, 체력은 다음 판으로 이어진다.',
    'run.new': '새 런',
    'run.seed': '씨앗 {n}',
    'run.stage': '{n} / {total} 판',
    'run.draft.title': '뽑기 {n} / {total}',
    'run.draft.note': '셋 가운데 하나. 왼쪽은 아직 두 번 클 수 있고, 가운데는 한 번, 오른쪽은 다 컸다. 지금 세기와 나중에 클 여지 사이에서 고른다.',
    ...
    'run.again': '다시 — 새 씨앗으로',
    'run.hp': '체력 {n}%',
    'run.help': '세 장을 뽑아 일곱 판을 이어 싸운다. 체력은 다음 판으로 이어지고, 이기면 조금 숨을 돌린다. 판 사이에 진화(전부 한 단계, 체력이 찬다) 아니면 회복(절반) 을 고른다. 마지막 판에는 전설이 낀다.',
    'battle.title': '전투 시험장',
