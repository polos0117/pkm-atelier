...
(function (root) {
  ...
  "referenceActionHead": "Eyes, bangs and the jaw outline stay visible in every form; headgear seats on the sheet's head hardpoints without shrinking the skull or changing the haircut. Species head features stay as permanent equipment.",
  ...
  const ACTION_FORM_PROFILES = {
    ...
    "heavy": "HEAVY: enclose the unchanged reference body with layered armor around chest, back, ribs, abdomen, waist, pelvis, upper arms, forearms, thighs, knees, shins and feet. Use a segmented waist, wraparound cuisses, substantial shoulder and forearm shells and deep load-bearing greaves. The larger silhouette comes from shell thickness and clearance around the original body. HEAD: an open-face helmet may cover crown, temples and occiput on the sheet's head hardpoints; eyes, bangs and jaw stay open.",
