...
'traditional':'그 캐릭터의 계통에 맞는 전통 의상. 정장형과 현대화된 일상형 중에서 고른다. 고증을 지키되 색은 원본 포켓몬를 따를 수 있다.'};
  ...
  const STYLE_PROFILES = {
    ...
    glossy_promo: {
      "core": "Premium anime-mecha promotional key art with clean linework, dense hard-surface mechanical detailing, strong dimensional shading, vivid but elegant colors, polished 2.5D character rendering, and a high-end campaign illustration finish. FACE: clearly adult anime facial design with expressive eyes, clean illustrated features and grouped illustrated shadow shapes. Define the nose, lips and cheeks with economical lines and deliberate shadow boundaries, with selective soft transitions rather than airbrushed beauty-portrait modelling; preserve the selected or approved facial identity, age, ethnicity, hair and proportions. FINISH: crisp controlled linework and a clean silhouette, substantial painted volume and selective glossy highlights on hair and hard mechanical surfaces. Restrained skin highlights and broad, clean anatomical shadow shapes keep skin soft and living; avoid wet-look skin and glossy lip emphasis. Avoid flat cel-only rendering, photographic skin and literal CGI or raw PBR presentation. LIGHT AND MATERIALS: strong dimensional lighting with clear lit-plane versus shadow-plane separation, deep contact shadows within existing mechanical gaps and refined reflections; distinguish living skin, flexible fabric and rigid mechanical surfaces. Skin must not inherit metallic armor gloss. Vivid color remains elegant and faithful to the chosen palette. STYLE AUTHORITY: rendering never changes body thickness, armor coverage, equipment, pose or framing. Mechanical density means resolved construction, not extra plates or a larger body. Do not force a background, expression, dramatic perspective, shallow focus or combat effects; follow the selected scene and output mode. Reference sheets retain their required views, comparison portraits their full-body camera and scale, and casual scenes their everyday setting. TEXT AND GRAPHIC OVERLAYS: no typography, captions, numbers, labels, interface panels, logos, watermarks or decorative pseudo-writing. No unsolicited inset panels or promotional page layout.",
      "anthro": "Render the selected source-derived mechanical design with dense hard-surface detailing: thick readable edges where designed, purposeful panel seams, articulated joints, recessed fasteners, compact actuators and convincing attachment points. Preserve the selected form and source silhouette; detail does not authorize extra equipment, increased coverage or anatomical enlargement. Use broad dimensional planes, crisp bevel highlights, dark recessed joints and controlled glossy reflections to give existing armor convincing weight. Resolve visible plate thickness, inner-frame connections and mechanical joint depth even in light armor; do not render plates as thin decorative stickers on a smooth suit. Apply this through the existing construction without adding heavy-form stacked shells. Keep the human face visibly anime-designed while body and machinery share polished 2.5D shading and the same light field. Keep hands, feet, defining equipment and material boundaries readable. No textual decals or serial numbers.",
      "lifestyle": "Use the same adult anime facial design, clean linework, strong dimensional shading, vivid but elegant colors and polished 2.5D finish for clothing, hair, skin and the requested environment. Preserve identity and body proportions. Express fabric through seams, drape and material-appropriate highlights; do not turn clothing or skin into hard shells. Mechanical equipment and combat effects appear only when requested. The scene controls expression, pose, location and composition. No writing, logos or promotional overlays."
},
    mecha_cinematic_keyart: {
      core: [
  ...
  "sourceDesignCreate": "SOURCE-TO-MECHANISM DESIGN: Start from a fresh design; do not continue previously generated characters or reuse their armor template. Identify a few defining features of the selected source, then translate each into a functional mechanical structure with a readable purpose, silhouette, mounting point and articulation. Make the strongest source feature a primary silhouette element rather than a small ornament. A source back bulb, when present, can become a substantial rounded, layered seed reactor mounted clearly to the back, built from overlapping rigid shell segments with readable rims, recessed seams, a load-bearing mechanical cradle and articulated cable sockets rather than a smooth flower-bud ornament; botanical features can become leaf-shaped hard-surface fins and vine-like articulated cables with compact leaf or pod terminals. Apply these botanical translations only to sources that actually have those features; other sources require their own equally specific engineering. Carry characteristic color blocks and irregular markings onto appropriate shells. Allocate visual mass in source-defining external equipment, shoulder structures and lower-leg armor while keeping the chosen human anatomy independent of equipment size. Keep the defining equipment readable in the requested views. Integrate head fins or sensory units into mechanical construction rather than costume ears. Use restrained source-appropriate sensor accents; never impose one species palette or eye color on every character. The result should evoke the selected source through structural design and stand alone as an original mechanical heroine, not a human in a mascot costume. Resolve source design first, then adult identity, selected armor form, rendering style and output layout; this design process never overrides explicit appearance settings or the required output mode.",
  "sourceDesignReference": "SOURCE-TO-MECHANISM DESIGN: Preserve the approved source-to-mechanism design, defining equipment, characteristic color blocks, markings and attachment logic. Do not start a fresh character or replace the established signature equipment with a newly interpreted source motif. A selected form may transform protective shell thickness, coverage and arrangement around the same person while retaining the source-specific engineering. Allocate visual mass in source-defining external equipment and authorized armor outside the unchanged anatomy. For overdrive, open the existing base equipment rather than inventing a replacement reactor or appendages.",
  ...
  "materialCommon": "Material identity and rendering style are separate. Express each material through the selected style; do not force photorealistic pores, fabric microtexture or CGI reflections into styles that simplify them. Preserve the chosen design, body proportions, coverage and material boundaries. Do not convert covered areas into bare skin or change coverage merely to fix a texture problem. An explicit FORM DEFINITION or outfit request may change outer coverage; this does not authorize changing anatomy or reclassifying underlying skin and textile. Source colours are not evidence that a region is skin. In new designs, make the boundary between exposed skin and worn materials unambiguous; in reference continuation, retain the established boundaries rather than reclassifying ambiguous regions. Exposed human skin is living skin, with the character's own skin tone, gentle tonal variation and soft anatomical shading, not a rigid shell, painted metal or moulded plastic. Keep skin highlights distinct from hard-surface reflections within the selected style. Material shading must not impose panel seams, bevels or shell-like edges on bare skin.",
  "materialArmor": "BODYSUIT: covered areas remain flexible textile, distinct from skin and rigid armor through appropriate seams, subtle tension folds and a softer, generally matte response. A cream or flesh-coloured bodysuit remains fabric, not simulated bare flesh or an anatomically moulded glossy shell. Preserve an explicitly selected specialty fabric or finish instead of replacing it automatically. ARMOR: reserve rigid thickness, bevels, panel breaks and hard edge highlights for actual armor and mechanical equipment. Do not spread the armor's lacquer or metallic finish across the body or undersuit. These are material cues, not permission to add plates, bulk, exposed areas or equipment. When armor opens, reveal the established underlying material, usually bodysuit, never bare skin by default.",
  ...
  const FORM_PROFILES = {
  "light": "LIGHT: one main protective armor layer with a compact supporting frame and flexible joint interfaces. LIGHT STRUCTURAL DEPTH: light describes the number of armor layers and freedom of movement, not paper-thin plates or absent machinery. Give existing plates readable cross-sections, bevelled rims, recessed connections and mechanically articulated joints; avoid the multiple stacked protective shells and broad enclosed housings of heavy armor. In new designs, organize armor and its supporting frame into a coherent source-derived structure. Flexible textile can connect regions where needed; this does not require a continuous bodysuit or broad uninterrupted pale suit panels to dominate the torso and legs. A continuous suit remains valid when explicitly requested. Do not reduce textile dominance by automatically exposing more skin or adding heavy armor. Preserve approved coverage and skin/textile boundaries in continuation; resolve the existing construction without inventing parts merely for detail. Keep anatomy independent of shell depth. This describes layering, not a compulsory amount of skin exposure.",
