...
(function (root) {
  ...
  "portraitCamera": "Full-body form portrait, vertical 2:3. Keep head, feet and mounted equipment in frame with clear margins; no foreground occlusion and no cropping of limbs or equipment. FREE POSE AND VIEWPOINT: choose the camera angle, body turn and pose that best reveal this armor form's defining equipment. A back-mounted unit, shell, tail or wing may justify a three-quarter or turning stance, a low or high camera, or a mid-motion pose; dynamic staging is welcome while the whole silhouette stays readable and the figure fills the frame. Forms may differ from each other in angle and pose; matching angles across forms is not required. Rotate torso, pelvis and mounted equipment together as one coherent body; never twist only the shoulders or pull equipment sideways to display it. The sheet's main front view controls anatomy and proportions; rear views/insets explain equipment. Compose one full-body figure, never the sheet layout or its reduced figure scale. OVERDRIVE EXCEPTION: an overdrive portrait keeps the camera angle, pose, subject scale and framing of its base form's approved normal portrait so the pair reads as the same figure opening up. An action/casual reference does not impose its camera. Explicit user viewpoint instructions override the default. Preserve shell/tail mounts and established dimensions; allow naturally visible shell curvature, rim and distal tail. COMPARISON ENVIRONMENT: Use a recognizable setting with spatial depth, such as a lab, hangar or greenhouse suited to the design. If the reference has no setting, establish one once; otherwise retain its setting. Keep the same location, background layout and lighting across forms. Use restrained detail and contrast behind the readable figure, with no foreground obstruction. Render the setting in the selected style, including sparse painted or ink suggestions where appropriate; avoid an empty studio void by default. Do not shrink the figure or change framing to show scenery. Explicit user background requests override this default.",
  ...
  "portrait": "SINGLE-FIGURE COMPARISON PORTRAIT: generate exactly one full-body depiction of the approved woman showing the selected armor form clearly. Pose and viewpoint follow CAMERA & PRESENTATION and may be dynamic; legible layer boundaries and readable equipment come first, with restrained effects. No secondary view, duplicate figure or detail inset, even when the identity reference is a multi-view character sheet.",
  "overdrivePortrait": "SINGLE-FIGURE COMPARISON PORTRAIT. OVERDRIVE COMPARISON STAGING: exactly one full-body depiction of the approved woman in the selected base armor under visible high-output strain. Legible opened panels, concentrated source-specific energy and tense hands or a braced stance distinguish this state from the normal portrait. Keep the camera angle, pose, subject scale, framing and full silhouette of that base form's approved normal portrait (the second attachment); only the opened state, energy and tension change, without an action leap or a new viewpoint. This replaces the normal portrait's restrained-effects default. Preserve an explicitly selected expression. No secondary view, duplicate figure or detail inset.",
