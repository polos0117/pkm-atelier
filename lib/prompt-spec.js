...
(function (root) {
  ...
  "referenceActionInput": "IMAGE-GUIDED CONTINUATION. Use the attached user-approved reference image or images as the identity and equipment authority. Generate one new action image in the selected form and style.",
  ...
  "sourceAppearanceScope": "These cues describe the source creature, not the human body or a fixed mecha blueprint. Translate selected cues into equipment shapes, materials and markings; chosen human appearance takes priority.",
  "sourceDesignCreate": "SOURCE-TO-MECHANISM DESIGN: Start from a fresh design. CREATIVE ENGINEERING PREPASS: before one image call, record function, shape, materials, colors and anatomically correct body-space mounts in the prompt, not on canvas. User choices take priority. Distinguish core equipment and form-specific armor parts. Optional is not absent by default. Hidden or stowed does not mean absent. Combine source anatomy and type into one signature mechanism. For sheets, resolve FEATURE INSET LIST into the person, the head-to-shoulder design language with its hardpoints, and the rear mount of permanent equipment; reuse the same parts in every view and inset. Include the concise design record with the result, provisional until approved.",
  ...
  "headCommon": "HEAD AND FACE: headgear is form armor, not identity. Eyes, brows, bangs, nose, mouth and jaw outline stay visible and unchanged in every form; never shrink the skull or reshape the face for headgear; hair keeps its cut and color through designed openings. Species head features (ears, horns, crests, leaves, flames, antennae) are permanent equipment at the head hardpoints, unlike sensor fins.",
  "referenceActionRoles": "REFERENCE ROLES: the front view fixes body proportions; the rear view and the rear-mount inset fix where permanent equipment roots and how it connects; the head-to-shoulder inset is a design-language sample: reuse its panel division, rim section, fastening, light lines and material pairing across the whole armor, while size, layer count and shape follow the selected form. Do not copy the light shoulder or its headgear into other forms. A form change alters outer armor and headgear only.",
  "referenceActionDiscipline": "PLATE DISCIPLINE: each armor region is one dominant plate plus at most two secondary plates: broad faces, thick rims, at most one light line per plate. Pistons, hoses and exposed joints only at elbows, knees and equipment roots; never tile a region into small panels or strips. Core equipment keeps the sheet's size against the torso: the shell stays as wide as the back, never a small backpack, with the form's armor built around it. STYLE CORE renders these plates and adds none.",
  "referenceActionHead": "Eyes, bangs and the jaw outline stay visible in every form; headgear seats on the sheet's head hardpoints without shrinking the skull or changing the haircut. Species head features remain permanent equipment.",
  "referenceActionDesign": "The approved sheet defines the core equipment, colors, markings and body-relative attachment points. Keep each core component's function, overall dimensions and recognizable silhouette. The selected form changes protective armor layering or panel state. Equipment follows the moving torso or pelvis as one connected assembly, with natural occlusion.",
  "referenceActionIdentity": "Depict the same woman from the approved identity anchor. Match face geometry, eye colors and side assignment, skin tone, haircut and color, height and body proportions. Expression and natural hair motion may respond to the action.",
  "referenceActionForm": "The reference body keeps its exact proportions inside every form. Add armor volume outside that body. Keep approved core equipment and source-derived colors while making the selected form readable at thumbnail size.",
  "referenceActionSymmetry": "Paired shoulder, arm, thigh, knee, shin and footwear armor uses matching parts and mounting levels unless the approved design is intentionally asymmetric.",
  "referenceActionMaterial": "Render skin with soft anatomical shading, the undersuit as flexible fabric, and armor as rigid plates with visible thickness, seams and hard highlights. Existing skin and fabric boundaries follow the reference except where the selected form explicitly adds outer armor.",
  "referenceActionOutput": "Create one dynamic full-body card illustration of the selected form. Keep one readable figure and a clear action silhouette. Unless scene selections specify otherwise, use a vertical 2:3 frame, keep head and feet in frame, and turn the face toward the camera in a front or three-quarter view. Back-mounted equipment stays at its mount and is revealed by a body turn, a three-quarter view or a low camera, never by relocating it; partial occlusion by the body is correct and in-frame means uncropped, not fully visible.",
  "referenceActionPriority": "Explicit scene selections control pose, orientation, framing, lens, equipment use, effects and setting while identity and the selected form remain fixed.",
  "referenceActionFinal": "Verify one coherent woman with two arms and two legs, the approved identity, the selected armor form and the selected style. Show every core component once at its established body-relative mount. Keep captions, logos and watermarks absent.",
  "referenceActionRearMount": "REAR UNIT: keep the approved rear unit at its established body-relative mount. Its visible structure connects continuously to the back and follows the torso through the action.",
  "referenceActionOcclusion": "OCCLUSION: rear equipment sits behind the torso and pelvis and follows their rotation; it is never shifted to a shoulder, flank, hip or arm to be seen. A shell rim above the shoulders or beside the flank and a tail tip beside the hip are enough. FAIL: shell resting on one shoulder or beside the torso; tail rooted at the hip, waist or arm.",
  "referenceActionRearPose": "Camera (default for rear-mounted equipment): a rear three-quarter view caught mid-action, never a standing pose. The camera sits about 45 degrees behind one shoulder and slightly low while the body lunges, sprints or twists through the selected action with its full motion and effects; the shell shows between the shoulder blades, the tail trails behind the pelvis, and the face turns back toward the camera over the near shoulder. This is a camera choice only: the equipment is seen where it is mounted, so nothing needs to move.",
  "referenceActionShellMount": "SHELL: center the approved shell or carapace on the spine with its inner face toward the back and its dome projecting rearward. Shell, tail and nozzle roots remain mechanically separate.",
  "referenceActionTailMount": "TAIL: root the approved tail on the posterior pelvic centerline. It extends rearward in depth before curving and follows the pelvis through the action.",
  ...
  "overdrive": "OVERDRIVE is an unstable high-output state, not a maintenance or cooling demonstration. Open selected existing seams and panels of the base armor; do not open every joint by default. Reveal the established inner frame and bodysuit. Combine mechanical opening, visibly stronger source-appropriate energy and bodily tension. Bright internal cores and seams cast local light onto nearby armor; concentrated energy escapes from opened regions; tense hands, a braced stance and focused intensity convey strain without changing anatomy. Explicit expression settings remain authoritative. Intensify the existing elemental signature: fire sources may amplify their flames with heat distortion and embers, electric sources use discharge arcs, and other sources use their own characteristic energy rather than universal fire or lightning. Keep the face, hands, panel boundaries and silhouette readable; avoid a frame-filling effect cloud. Preserve the base armor's recognizable structure, colors, mass and attachment points. Do not invent extra shoulder or thigh blocks, weapons or appendages to manufacture an opening. Floating is optional and limited to panels already present in the base armor, with a clear relationship to their original attachments. Opening is not bodily mutation, a different person or automatic escalation to the heaviest armor. Head: only open or deploy the base form's existing head panels, fins or visor; never generate a new helmet. Energy follows the selected rendering style: even restrained styles must show relative escalation through visible opening, concentrated energy cues and bodily tension without abandoning their style.",
  ...
  const ACTION_FORM_PROFILES = {
    "light": "LIGHT: fit one compact protective layer at the shoulders, arms, hips or thighs and lower legs. Use clear joints, beveled plate depth and flexible gaps for an agile regional silhouette. HEAD: no helmet beyond the sheet's small temple sensor or headband frame.",
    "heavy": "HEAVY: thick outer shells standing off the unchanged body on visible clearance and stand-off brackets: one cuirass with one abdomen band, one pelvic plate, and per side one shoulder housing, one upper-arm shell, one forearm shell, one wraparound cuisse, one knee cap, one deep greave and one boot. Each is a single broad plate with a thick rim and few seams. Thickness and clearance make the silhouette larger while her own outline at the hip joints, thighs, waist and knees stays exactly the sheet's; where heavy covers bare skin, the shell floats over it rather than thickening the limb. Heavy adds protection only: no cannons, weapons or new appendages. HEAD: an open-face helmet may cover crown, temples and occiput on the sheet's head hardpoints; eyes, bangs and jaw stay open.",
    "mobility": "MOBILITY: arrange thin armor into an outward, swept-back silhouette with directional panels, compact propulsion structures and clear negative space. Keep joints free and make the silhouette visibly different from compact light armor at thumbnail size. HEAD: slim rearward sensor fins from the temple hardpoints and a thin occipital frame; no crown-covering helmet."
  };
  const ACTION_MOUNT_HINTS = {
    shell: ["shell","carapace","turtle","tortoise","squirtle","wartortle","blastoise","등껍질","등갑","거북","꼬부기","어니부기","거북왕"],
    tail: ["tail","꼬리","squirtle","wartortle","blastoise","charmander","charmeleon","charizard","꼬부기","어니부기","거북왕","파이리","리자드","리자몽"],
    rear: ["backpack","back-mounted","rear unit","seed","bulb","reactor","등 장비","백팩","씨앗","구근","꽃봉오리","bulbasaur","ivysaur","venusaur","이상해"]
  };
  const ACTION_STYLE_CORES = {
    cinematic_semi_real: "Cinematic semi-real illustration with believable anatomy, painterly skin and hair, solid mechanical volume and controlled film lighting. Keep the face clearly illustrated, the materials distinct and the action readable.",
    game_keyart: "Polished 2.5D game key art with clean linework, controlled anime facial design, layered cel-to-soft shading and crisp mechanical detail. Use a vivid, readable silhouette and campaign-quality lighting.",
    glossy_kr_game: "Glossy Korean mobile-game character art with an elegant anime face, smooth dimensional shading, luminous color accents and refined hard-surface armor. Keep highlights selective and the figure sharply readable.",
    glossy_promo: "Premium glossy anime-mecha promotional key art with clean linework, vivid controlled color, dimensional 2.5D shading and dense but organized hard-surface detail. Match the face and armor at the same polished rendering intensity.",
    mecha_cinematic_keyart: "Illustration-first mecha cinematic key art with a clear anime face, saturated campaign color, convincing hard-surface volume, strong rim and key light and a crisp readable environment. It reads as authored premium illustration rather than literal CGI.",
    game_cgi: "High-end stylized game CGI with coherent three-dimensional anatomy, physically convincing armor construction, clean materials and dramatic production lighting. Preserve a designed character-art finish rather than live-action texture.",
    semi_real_paint: "Sophisticated semi-real digital painting with natural anatomy, restrained facial stylization, broad painterly planes and tactile mechanical surfaces. Use composed light and visible brush character without losing structural clarity.",
    photoreal: "Photoreal cinematic character photography with plausible anatomy, lens behavior, lighting and material response. The mechanical equipment reads as a physically built costume or machine integrated into the photographed scene.",
    anime_illust: "Detailed modern anime illustration with expressive linework, clear facial features, controlled cel shading and crisp mechanical construction. Use dimensional color and lighting while preserving an unmistakably drawn finish.",
    cel_anime: "Clean cel-anime art with decisive outlines, limited stepped shadows, flat controlled color and readable graphic shapes. Mechanical parts stay structurally clear through line and silhouette rather than surface noise.",
    painterly: "Painterly fantasy character art with expressive brushwork, shaped color masses, atmospheric depth and solid mechanical forms. Preserve readable edges at the face, hands and equipment anchors.",
    retro_anime: "Retro hand-painted anime key art with confident ink lines, simplified mechanical shapes, warm cel colors and period-style painted lighting. Keep the composition bold and graphic.",
    ink_wash: "Ink-and-wash character illustration with expressive brush outlines, diluted ink values, restrained translucent color and open paper-like atmosphere. Use selective dark accents to keep the mechanical silhouette readable.",
    bright_catalog: "Bright polished catalog illustration with clean neutral lighting, crisp color separation, controlled reflections and highly readable armor construction. Keep the character vivid against a simple spatial environment."
  };
  const FORM_PROFILES = {
  "light": "LIGHT: separate regional armor assemblies on a compact supporting frame: one protective layer at shoulders, arms, hips/thighs and lower legs, with flexible interfaces instead of full enclosure. Lightness comes from regional coverage and articulation, not flimsy plates. Skin exposure is optional; outfits may fill gaps. LIGHT STRUCTURAL DEPTH: plate cross-sections, bevelled rims, recessed connections and articulated joints, without heavy stacked shells. This does not require a continuous bodysuit or broad pale panels; honor explicit suits. Preserve approved coverage and skin/textile boundaries in continuation; detail adds no anatomy or equipment. HEAD (light): no helmet; at most a small temple sensor or a slim headband frame that reveals the head hardpoints.",
  "heavy": "HEAVY: multiple overlapping protective layers forming a full-body armored shell outside the unchanged person. HEAVY COVERAGE: FULL-BODY ENCLOSURE: connect protection around the chest, back, lateral ribs, abdomen, waist, pelvis, upper arms, forearms, thighs, knees, shins and feet. Wrap front, sides and rear rather than leaving light-form body gaps between isolated plates. Use segmented abdominal and waist plates, articulated pelvic protection and wraparound cuisses covering the front and outer upper thighs as well as their rear surfaces. HEAD (heavy): an open-face multi-layer helmet may cover the crown, temples and occiput, mounted on the temple, behind-ear and collar hardpoints; eyes, bangs and jaw stay open. Small flexible joint clearances at neck, armpits, elbows, groin and knees permit movement but must not become large exposed torso or thigh windows. Heavy selection itself authorizes outer armor over previously exposed skin or textile, including the abdomen; preserve those underlying materials without enlarging the body or adding padded flesh. This applies to both new creation and a transition from a lighter reference. Explicit user coverage exceptions take precedence. Build substantial shoulder housings, forearm shells and load-bearing greaves, with thick rims, recessed joints and deep overlaps. Each greave has one dominant broad front plate and a deep wraparound side housing, not repeated thin fins. Preserve source colors, motifs and selected core equipment; body protection is not a new source appendage. Added thickness is external shell and clearance, not increased anatomy. BODY / SHELL SEPARATION: treat this as replacing external equipment on the same person, not generating a heavier-bodied person. Establish anatomical shoulder joints, ribcage, bust, natural waist, pelvic width, hip joints and inner-thigh contours from the selected anatomy for new creation or authoritative identity view for continuation before fitting armor. Preserve head-to-pelvis, pelvis-to-knee and knee-to-ankle relationships and limb thickness, accounting for pose and perspective. Keep visible skin and fitted textile contours at the established dimensions; do not pad or round the undersuit to merge it into the outer shell. The body does not need to fill the armor cavity. Use stand-off brackets, recessed connections and air space between the unchanged body and thick shells. Add protective volume outward and forward from the body, without spreading hip joints, widening the pelvis or moving inner-thigh contours inward to fill the shells. Do not infer a larger breast or ribcage from a larger chest cuirass; its internal clearance and shell thickness explain the outer volume. Retain broad external shoulder housings, thick forearms and heavy greaves; anatomy correction must neither shrink the armor into a light form nor make the person thinner than the selected or approved anatomy. A secondary armor reference controls equipment only, even if its body has drifted. Preserve underlying skin/textile boundaries; outer armor may cover them as authorized, but do not invent additional padding or fabric across uncovered skin.",
  "mobility": "MOBILITY: use thin armor arranged outward into a visibly expanded, agile silhouette distinct from regional light armor and enclosing heavy armor. Use source-derived swept-back fins, separated directional panels and compact rearward propulsion structures with clear negative space and readable attachments. Reduce obstructive armor around moving joints while retaining established underlying skin/textile boundaries. The difference must be visible at thumbnail scale through projection, direction and spacing, not merely smaller light-armor plates, a few glowing strips or more skin exposure. Keep exact reference body thickness and proportions. Avoid heavy stacked housings, generic giant wings and unrelated equipment; adapt directional structures to the source motifs. HEAD (mobility): slim rearward sensor fins or flow-control antennae from the temple hardpoints and a thin occipital frame, smaller and sleeker than a heavy helmet; no crown-covering helmet."
};
  ...
  "action": "ACTION: generate one dynamic scene using the selected armor form. Pose, viewpoint, motion, effects and environment may be dramatic while the woman and form remain recognizable. Action is a presentation mode, not an additional armor form. CARD-READY DEFAULT: unless Scene details ask for a different orientation or framing, this image must also work as the form's card art — one figure, vertical frame, head and feet inside the frame with clear margins, no foreground occlusion, face turned toward the camera (front or three-quarter, never a back view), and this form's defining equipment readable. Let the mid-motion pose, body turn or a low/high camera reveal back-mounted gear, shells, tails or wings without turning the character away. OVERDRIVE IN ACTION: when the form is overdrive and this form's approved normal image is attached, keep its camera, pose and subject scale and change only the opened state, energy and tension, so the pair reads as the same figure opening up.",
  ...
  const REFERENCE_SHEET_PROFILE = {
    "output": "INITIAL CHARACTER REFERENCE SHEET: same individual and same selected armor configuration in every view. Layout: large front full-body view left; equal-scale rear three-quarter full-body view center; exactly three detail insets stacked in the right column following FEATURE INSET LIST top to bottom, each large enough to read at reduced size. Document one design, not variants.",
    "featureRule": "Each inset is a dedicated close-up of its named subject; generic armor or full-body repeats do not count. No mandatory backpack or weapon. Explicit user targets take priority.",
    ...
    "negative": "INSET FIDELITY LOCK: Each inset magnifies its named installed component or surface region, never a new design. Match main-view silhouette, panels, colors, markings, channels, fasteners and mounts; finer detail may increase, structure may not. Plan details before views. Keep face, hair, anatomy, coverage and left/right identity identical. Each full body has two arms and two legs; appendages are equipment. If tailed, the rear three-quarter view must show the posterior sacral attachment and the REAR MOUNT inset documents that same connection. No alternate faces/outfits, extra limbs, childlike proportions or text overlays.",
    "final": "Verify both full-body views and all three named matching detail insets, readable face and attachments, consistent anatomy and selected style. This sheet becomes an identity anchor only after user approval."
};
  /* 기준 시트 오른쪽 세 칸. 자료(source-appearance)가 채우는 칸은 REAR MOUNT 하나뿐이고,
     뿌리가 있는 부위만 온다 — 색·피부·몸통 덩어리는 확대컷 대상이 못 된다. */
  /* 후면 장착부에 올 수 있는 부위. 귀·뿔·더듬이처럼 머리에 붙는 것은 여기 없다 — 그건 머리–어깨 칸의 하드포인트가 맡는다 */
  const INSET_MOUNT_PARTS = ["shell", "carapace", "tail", "bulb", "bud", "flower", "seed", "wing", "crest", "fin",
    "leaf", "frond", "flame", "tentacle", "vine", "tendril", "cannon", "magnet", "gear", "stinger", "sac",
    "plant", "tree", "branch", "trunk", "stalk", "cap",
    "등껍질", "등갑", "꼬리", "구근", "봉오리", "꽃", "씨앗", "날개", "볏", "지느러미", "잎", "불꽃", "촉수", "덩굴"];
  const INSET_HEAD_PARTS = ["ear", "horn", "antler", "crest", "antenna", "antennae", "feeler", "whisker", "pouch", "mane",
    "귀", "뿔", "볏", "더듬이", "수염", "볼주머니", "갈기"];
  /* 포켓몬 머리 특징을 경장 인물의 머리에 어떻게 옮기나. 헬멧은 여기 없다 — 헬멧은 폼이 정한다.
     [열쇠, 화면 이름, 프롬프트 문장] */
  const HEAD_FEATURE_OPTIONS = [
    ["", "자동 — 원본 머리 특징에 맞춰", ""],
    ["none", "없음 — 머리는 비우고 특징은 다른 부위에", "no species head feature on the head; the head hardpoints stay minimal and the feature lives elsewhere on the armor"],
    ["mechanical", "기계 부품 — 센서 귀·장갑 뿔처럼", "the species head feature becomes a mechanical part mounted at the temple or behind-ear hardpoints, such as sensor ears or armored horns, permanent across forms"],
    ["ornament", "헤어 장식 — 머리핀·리본·머리띠로 형태와 색만", "the species head feature is echoed by a hair ornament (hairpin, ribbon, headband) carrying its shape and colors, not a mechanical part"],
    ["accessory", "악세사리 — 귀걸이·이어커프·초커 같은 장신구", "the species head feature is echoed by jewelry-like accessories such as earrings, ear cuffs or a choker, small and wearable, not armor"],
    ["sensor", "센서 핀 — 관자놀이에서 뒤로 뻗는 얇은 핀", "the species head feature becomes slim sensor fins or antennae sweeping back from the temple hardpoints"],
    ["__custom__", "직접 입력…", ""]
  ];
  const PARAM_GUIDES = {
    "body type": {
  ...
  root.AtelierSpec = {
    ...
    PROJECT_RULES, FORM_PROFILES, ACTION_FORM_PROFILES, ACTION_MOUNT_HINTS, ACTION_STYLE_CORES, OUTPUT_PROFILES, REFERENCE_SHEET_PROFILE, INSET_MOUNT_PARTS, INSET_HEAD_PARTS, HEAD_FEATURE_OPTIONS, IDENTITY_GROUPS, IDENTITY_EXCLUDED,
