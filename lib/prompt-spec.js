...
'traditional':'그 캐릭터의 계통에 맞는 전통 의상. 정장형과 현대화된 일상형 중에서 고른다. 고증을 지키되 색은 원본 포켓몬를 따를 수 있다.'};
  ...
  "heavy": "HEAVY: multiple overlapping armor layers with substantial solid volume, thick cross-sections, recessed joints and deep stepped overlaps. Build broad load-bearing shoulder housings, substantial forearm shells and reinforced lower-leg armor outside the unchanged body. Show structural supports and clear spacing between body, inner frame and outer shell. Distribute mass deliberately rather than thickening every surface uniformly. The silhouette must read as heavy protective equipment at thumbnail scale, not light armor with extra thin feather-like plates or decorative fins. Keep exposed body contours and waist at reference size; added width belongs to armor only. Do not enlarge breasts, torso, hips or thighs, lengthen limbs, or substitute extra weapons for protective mass. HEAVY COVERAGE: increase both shell thickness and protective area relative to light armor. Build a unified substantial upper-chest cuirass connected to lateral rib protection and a backplate, and independent thick cuisses covering the front and outer upper thighs. Broad shoulder housings, deep enclosed forearm shells and load-bearing greaves must read as large solid protective masses, not the light layout with extra pointed plates. Each greave has one dominant broad front plate and a deep wraparound side housing, thick bevelled rims and a few purposeful recessed seams; avoid repeated narrow feather plates and swept-back decorative spikes. Keep the central abdomen and natural waist in the established flexible undersuit by default, with flexible clearance at neck, elbows, groin and knee articulation. Respect explicit user coverage requests. This selected heavy-form transformation authorizes rigid armor over previously visible undersuit areas of chest and front/outer thighs; retain the same opaque underlying textile and never convert it into skin. Preserve source-specific motifs without forcing any species palette or equipment. BODY / SHELL SEPARATION: first establish the reference body's ribcage, bust, pelvis and limb contours without armor, then fit the equipment around that same body. In particular, fabric-covered upper thighs must follow the reference anatomy, not become wider padded or muscular volumes to support heavy armor. Keep the exposed abdomen, natural waist and anatomical shoulder width at reference dimensions. Make the distinction visible with stand-off brackets and spacing between the fitted undersuit, inner frame and rigid outer plates. Retain broad shoulders, substantial forearm housings and bulky greaves as external equipment; correcting the body must not shrink the armor into a light form. Match the reference body rather than making it thinner than the reference. Preserve head-to-pelvis, pelvis-to-knee and knee-to-ankle relationships; do not lengthen or widen the lower body to fill the armor. Outer bulk belongs to separate equipment on visible supports, never inflated anatomy. Maintain the underlying skin/textile boundaries and explicit coverage requests while applying the authorized outer-shell coverage expansion; do not introduce new exposure.",
