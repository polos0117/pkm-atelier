...
'traditional':'그 캐릭터의 계통에 맞는 전통 의상. 정장형과 현대화된 일상형 중에서 고른다. 고증을 지키되 색은 원본 포켓몬를 따를 수 있다.'};
  ...
  const ART_STYLES=[
    ...
    [
      'glossy_promo',
      '글로시 프로모 키아트',
      '강한 원근감·발광 림라이트·스파크와 얕은 심도의 화려한 2.5D 프로모션 키아트. 포스터 같은 몰입감은 살리되 제목·번호·설명·UI·로고는 그리지 않는다.'],

    [
      'mecha_cinematic_keyart',
      '메카 시네마틱 키아트',
      '성인 애니풍 얼굴과 고밀도 하드서피스 메카를 결합한 시네마틱 키아트. 단독 컷에서는 입체적인 공간·조명과 정교한 장갑 재질을 살리고, 기준 시트에서는 같은 질감을 유지한 채 고정 구도를 따른다.'],
  ...
  const STYLE_PROFILES = {
    ...
    glossy_promo: {
      core: [
        "high-impact glossy promotional key-art illustration with luminous semi-real 2.5D rendering, energetic spatial depth, and a premium campaign-art finish.",
        "The image is richly illustrated rather than flat anime, live-action photography, or a literal 3D game-engine render.",
        "STYLE AUTHORITY: this style controls rendering, light, depth, and finish only. CHARACTER IDENTITY, FORM DEFINITION, OUTPUT MODE, and explicit scene settings remain authoritative for body proportions, coverage, armor structure, pose, camera, and composition.",
        "FACE: clearly adult, attractive anime-informed facial design built with soft dimensional modelling through the eyelids, nose bridge, cheeks, lips, jaw, and chin.",
        "Keep the exact facial structure, ethnicity, apparent age, eye geometry, and facial character defined by CHARACTER IDENTITY instead of replacing them with one recurring glamour face.",
        "SKIN: smooth luminous airbrushed gradients, warm subsurface-like colour, selective bright highlights, and deep but clean shadow colour.",
        "Skin remains illustrated and dimensional; avoid photographic pores, flat cel shading, waxy CGI, and uniformly wet-looking gloss.",
        "HAIR: layered flowing lock groups with bright highlight ribbons, backlit flyaways, selected fine strands, and controlled motion that follows the requested pose.",
        "LIGHTING: brilliant shaped key light, intense source-colour rim illumination, luminous bounce, art-directed bloom, and deep complementary shadows.",
        "DEPTH AND EFFECTS: use strong near-to-far separation, selective shallow depth of field, atmospheric bokeh, lens glow, and source-appropriate sparks, energy trails, or luminous motes when the selected form and scene support them.",
        "Effects frame the character and clarify movement without covering the face, anatomy, armor silhouette, hands, feet, or defining equipment.",
        "MODE DISCIPLINE: action scenes may use dramatic diagonal depth, wide-lens energy, and foreground-to-background scale; portraits and initial reference sheets keep their required neutral layout and camera while retaining the same luminous glossy finish; casual scenes use intimate environmental depth without importing armor or battle effects.",
        "COLOUR: push the source creature's main colours against a darker or complementary environment with bright focal accents, while preserving the selected design's actual palette.",
        ...
        "A simple non-text source-derived emblem or motif may remain only when it belongs to the character design itself.",
        "Avoid flat television-anime shading, matte unresolved concept art, photographic realism, generic fantasy ornament, raw PBR rendering, excessive blur, illegible silhouette, poster copy, and magazine or character-card layout."
      ].join(' '),
      anthro: [
        "ARMOR AND MECHANICAL SURFACES: render source-specific armor with crisp layered plates, dark articulated joints, designed specular streaks, luminous edge accents, and clear separation between painted metal, composite, glass, rubber, fabric, and exposed skin.",
        "Use fine mechanical detail and restrained edge wear only where compatible with the selected form; do not replace the source-derived armor with generic gacha heroine decoration.",
        "Let source-appropriate energy and backlight trace the armor silhouette and motion while keeping every defining attachment readable.",
        "The human face, body, armor, and effects share one coherent lighting system.",
        "Do not add textual decals, serial numbers, warning labels, interface callouts, title blocks, or promotional copy to the armor or background."
      ].join(' '),
      lifestyle: [
        "Render clothing, hair, skin, props, and environment with the same luminous glossy promotional finish, selective shallow depth of field, polished material separation, and warm or source-colour accent light.",
        "Keep the scene grounded in the requested everyday action. Do not import armor, combat particles, or explosive staging unless explicitly requested.",
        "Glamour comes from light, pose, expression, and finish; the style does not change body proportions, clothing coverage, or outfit intensity selected elsewhere.",
        "Screens, cups, packaging, signs, posters, books, and background objects contain no readable writing, numbers, logos, captions, or interface text."
      ].join(' ')
    },
    mecha_cinematic_keyart: {
      core: [
        "premium hard-surface mecha cinematic key-art illustration that combines a clearly adult anime-informed character with dense, high-end CGI-like mechanical rendering.",
        "The final image is an art-directed illustrated hybrid: more structurally precise and materially grounded than soft glossy 2.5D glamour art, while remaining more stylized and character-driven than a literal game-engine render or live-action photograph.",
        ...
        "FACE: preserve the exact clearly adult identity, ethnicity, apparent age, facial structure, and eye geometry defined by CHARACTER IDENTITY. Use attractive anime-informed proportions with convincing dimensional eyelids, nose bridge, cheeks, lips, jaw, and chin rather than a flat anime face or a recurring generic glamour face.",
        "SKIN: refined illustrated skin with smooth dimensional gradients, restrained subsurface warmth, selective clean highlights, and natural roughness variation. Avoid photographic pore noise, waxy game-CGI skin, porcelain plastic, and uniformly wet gloss.",
        "HAIR: organized three-dimensional lock groups, crisp silhouette strands, controlled flyaways, and physically coherent highlight flow. Keep the selected hairstyle and do not replace it with generic windblown glamour hair.",
        "LIGHTING AND SPACE: use bright cinematic key light, believable environmental bounce, defined rim separation, controlled bloom, and deep but readable shadows. Build a convincing large-scale three-dimensional environment around single-figure scenes without obscuring the character or overriding an explicitly selected setting.",
        "DETAIL HIERARCHY: keep the face, full-body silhouette, major armor masses, joints, hands, feet, and defining equipment sharply readable. Concentrate fine detail on mechanically meaningful areas and allow only distant background detail to soften.",
        "MODE DISCIPLINE: single-figure portraits and action scenes may use a full-body hero composition, strong environmental scale, and cinematic perspective. Initial reference sheets keep their required neutral multi-view layout and comparison portraits keep their fixed camera, but both retain the same face construction, hard-surface precision, material response, and lighting quality.",
        "TEXT AND GRAPHIC OVERLAYS: no typography, no headings, no numbers, no captions, no handwritten notes, no labels, no interface panels, no infographic bands, no borders, no logos, no watermarks, and no letter-like decorative marks anywhere in the image.",
        "Avoid soft low-detail airbrushing, dark featureless studio bokeh, flat cel shading, painterly unresolved armor, generic plastic bodysuits, raw PBR asset presentation, photoreal live-action skin, excessive bloom, illegible silhouettes, poster copy, and character-card layouts."
      ].join(' '),
      anthro: [
        "ARMOR AND MECHANICAL SURFACES: preserve the selected form and source-specific design while rendering crisp interlocking plates, purposeful panel breaks, recessed seams, fasteners, layered edge construction, articulated dark joints, and believable load-bearing connections.",
        "Use high-density hard-surface detail without changing a light form into heavy armor or covering exposed areas that FORM DEFINITION leaves open. Detail density is a rendering treatment, not permission to redesign armor coverage or silhouette.",
        "Separate painted armor, bare metal, composite, rubber, glass, emissive sensors, fabric, and skin through controlled roughness, reflections, edge highlights, and contact shadows. Keep the result art-directed and slightly illustrated rather than a raw physically perfect asset render.",
        ...
        "The character and environment share one coherent light field, with reflected source colours and contact light grounding the armor in the scene.",
      ...
      lifestyle: [
        "Render the same adult identity with cinematic dimensional modelling, crisp material separation, coherent environmental bounce, and the same controlled anime-informed facial construction, but omit armor and combat effects unless the selected scene explicitly requests them.",
        "Clothing and props use believable layered construction, fine seams, controlled highlights, and tactile fabric or hard-surface detail without becoming a literal game-engine render.",
  ...
  const PROJECT_RULES = {
  "createInput": "TEXT-TO-IMAGE NEW CHARACTER. Generate a new image from the written instructions. No input image is required: neither a character reference nor a source-creature picture needs to be attached.\n\nTO THE IMAGE-GENERATING ASSISTANT: invoke new image generation from text, not an existing-image edit. If the image tool exposes these arguments, omit both referenced_image_paths and num_last_images_to_include entirely. Do not automatically use earlier conversation images or assign an image-edit target to this request. These are call instructions for the receiving assistant, not text to draw in the image.\n\nThe named source creature provides design inspiration through its recognizable features; invent the adult human identity and selected armor from the text settings below. A reference sheet is the OUTPUT being created now for possible future use, not an input attachment or an existing image to locate. Begin creation from these instructions without waiting for an image upload.",
  ...
  "project": "Create a creature-inspired mechanical character design centred on one clearly adult woman. Translate a few distinctive source motifs into the armor structure itself, not generic armor with mascot decorations. Preserve a readable human silhouette and expressive personality appropriate to the source: friendly is a default possibility, not a mandatory emotion. Avoid generic military hardpoints, unrelated weapons, excessive industrial greebling and unrelated crests. Heavy forms may have substantial armor mass. Use painted metal, smooth synthetic shells, flexible bodysuit fabric, articulated joints and restrained luminous accents as appropriate. This project direction never replaces the selected rendering style.",
  ...
  "source": "Choose only the most recognizable and relevant motifs: characteristic color blocks, silhouette cues, markings or elemental language. Ears, tails, wings and horns are possibilities only when this species and the design warrant them, not a mandatory checklist. Translate those motifs coherently rather than attaching every feature. Source colors guide armor, hair accents and accessories; they do not dictate literal skin color or a nonhuman body. Do not substitute a canonical trainer, pilot or existing human character.",
  "create": "Invent one distinctive, clearly adult woman. Choose believable adult human anatomy and an individual face, hairstyle, hair color, eyes and skin tone. The source may suggest personality and palette, but must not force one generic attractive face or identical anatomy across different characters. Face geometry takes priority over an impression word; ethnicity is a broad cue, not a replacement for individual features. Body proportions are independent of armor thickness and coverage.",
  "reference": "Use the SAME clearly adult woman from the user-approved identity reference. The approved image is the stable identity anchor; a first draft is not automatically approved. Preserve facial geometry, adult age, ethnicity, eye shape and color including side assignment, nose, mouth, jaw, skin tone, hair color, hairstyle and length, height, build and body proportions. Expressions may change without changing facial structure; hair may move naturally without a haircut. Do not average identities or gradually replace the approved anchor with successive generated images. One approved reference image is sufficient. If an additional design image is supplied, it controls only the explicitly identified armor details, never a different face or body. Text appearance settings from the creation stage do not override reference identity.",
  "formCommon": "The same human body sits beneath every form. Form changes affect armor layering, thickness, arrangement and visible bodysuit, not height, bust, waist, hips, limb lengths or muscle mass. Keep source-derived colors and recognizable structural motifs. Armor is not an immutable identity lock.",
  "referenceForm": "Preserve attached design details where compatible with the selected form.",
  "overdrive": "Open selected existing seams and panels of the base armor; do not open every joint by default. Reveal more internal bodysuit than in that base state, with controlled mechanical and elemental energy. Preserve the base armor's recognizable structure, colors and placement. Do not invent extra shoulder or thigh blocks to manufacture an opening. Floating is optional and limited to panels already present in the base armor, with a visually clear relationship to their original attachment points. Opening is not bodily mutation, a different person or automatic escalation to the heaviest armor.",
  ...
  const FORM_PROFILES = {
  "light": "LIGHT: one main armor layer over a flexible bodysuit. Keep construction relatively close to the body, with clean separation between armor and joints. This describes layering, not a compulsory amount of skin exposure.",
  "heavy": "HEAVY: multiple overlapping armor layers with clear thickness, overlaps and separation at edges. Increase protective mass through armor construction, not by enlarging the woman's body. Do not reduce this to merely adding weapons or making every surface uniformly thick.",
  "mobility": "MOBILITY: use thin armor arranged outward to create an expanded, agile silhouette. Prioritize articulation and light outward fins or panels derived from the source. A wider silhouette does not mean heavy stacked layers or a thinner human body."
};
  ...
  const REFERENCE_SHEET_PROFILE = {
    output: "INITIAL CHARACTER REFERENCE SHEET: create one coherent design sheet of one clearly adult woman in the same selected armor configuration. The layout is mandatory: a large front full-body view on the left, a similarly sized rear three-quarter full-body view in the middle, and a narrow right-hand column containing exactly four detail insets. Both full-body views show the same individual, outfit, armor parts, colors, markings and attachment positions, not two characters or alternate designs. The four detail insets, from top to bottom, are: (1) a clear face close-up including the eyes, hairline and hairstyle; (2) a distinctive source-derived marking or armor construction detail already visible on the figure; (3) the main back-mounted structure or other defining source-derived equipment and its attachment; (4) the footwear and lower-leg armor construction. Adapt these details to this source and this design. If a marking or back-mounted part is absent, enlarge an existing characteristic panel, seam or rear armor attachment instead of inventing equipment. All enlarged details must match the main views exactly. The sheet documents a single form, not a comparison of different forms. Do not omit the detail column or reduce the result to only two standing views.",
    camera: "One vertical 3:4 canvas. Use the wider canvas area for the two large, equal-scale full-body views and reserve a narrow strip on the right for the four detail insets. Align the main figures' head and foot levels; keep the complete human silhouettes, head, feet and defining equipment visible. Use a neutral standing pose with clearly readable hands and limbs. The front view is frontal or very slightly three-quarter; the rear three-quarter view must clearly reveal the back armor and equipment attachments. The face inset stays large enough to resolve facial identity. Only the detail insets use close framing. Keep the main figures prominent: use the added width for the views and insets rather than empty margins, and do not pull the camera back or shrink the figures. Use restrained spacing and one quiet, low-detail background compatible with the chosen style. Maintain the same lighting and material language across every view. No action perspective, strong foreshortening or foreground occlusion. Background ornaments must not compete with the design.",
    negative: "The repeated views are intentional depictions of the same individual, never multiple people in one scene. Within each view, maintain one coherent adult human body with two arms and two legs; no accidental extra limbs, duplicate hands or fused figures. Source-derived appendages remain intentional equipment, not extra human limbs. For a tailed design, the rear three-quarter view and equipment inset must clearly show the tail's posterior attachment root at the sacrum or lower back and its physically continuous connection; the front view must not depict an attachment on the abdomen, front waist, side waist, chest or front hip. Use correct body occlusion so the tail cannot read as passing through or originating in the front of the torso. Preserve identical face, hair, body proportions, armor construction, markings and left/right placement across the front view, rear view and insets; do not mirror asymmetric features onto the wrong side. Close-ups document existing details and never add alternate faces, outfits, armor or equipment. Keep facial identity and anatomy independent of rendering stylization and armor volume. No childlike age regression, generic identity replacement, unrelated scenes, captions, numbers, labels, logos or watermarks. Lighting, surfaces and edge treatment follow the selected style throughout the sheet.",
    final: "Verify both large full-body views and all four detail insets are present and show the same adult woman in the same selected armor configuration. Confirm the face is readable, all enlarged design details match the main views, left/right assignments are consistent, and the rear view exposes the defining attachments. This sheet becomes an identity anchor only after the user approves it."
  };
