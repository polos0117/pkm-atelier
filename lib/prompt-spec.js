...
(function (root) {
  ...
  "sourceDesignCreate": "SOURCE-TO-MECHANISM DESIGN: Start from a fresh design. Translate the strongest source feature into functional equipment at anatomically correct body-space mounts. For a source with a back bulb, use a rounded seed reactor with overlapping rigid shell segments, recessed seams, a mechanical cradle and cable sockets. Botanical sources may use leaf fins and articulated vine cables; adapt each species. Build external equipment independently of human build; respect natural occlusion. Integrate head sensors into the engineering. Keep source colors, markings and equipment; mounting outranks visibility.",
  "sourceDesignReference": "SOURCE-TO-MECHANISM DESIGN: Preserve the approved source-to-mechanism design, signature equipment, colors and markings. MOUNT CORRECTION PRIORITY: Reconstruct attachment geometry using BODY-SPACE MOUNT LOCK, even when continuing the same form. This correction overrides attachment/silhouette preservation in reference, form and style instructions; retain the person, component inventory and surface design. Image approval alone does not approve an ambiguous attachment. Do not copy a reference overlap as a side-mounted component. Preserve equipment at anatomically correct body-space mounts; never relocate, enlarge or re-aim it for visibility. Apply the selected form through its external construction; overdrive opens the existing base equipment.",
  "sourceMounts": "BODY-SPACE MOUNT LOCK: For existing/chosen equipment only; invent no extra appendages. Center the shell cradle on the spine; inner face against the back, dome rearward. A tail has an independent sacral root on the posterior pelvic midline below the shell, extending rearward before curling. Separate shell, tail and nozzle mounts. Never mount the tail on the side waist, hip plate, flank, shoulder, arm or elbow. The curl follows the tail in 3D, not a camera-facing disk. All forms change construction/articulation, but do not relocate the main mounts. Keep body-relative mounts, not screen coordinates; hidden roots imply no side mount. Only explicit user mounting instructions override this.\n\nREAR EQUIPMENT OCCLUSION LOCK: Priority: mounting geometry > natural occlusion > front readability. In front or front-three-quarter views, keep posterior roots behind the torso and pelvis. Only distal tail portions may emerge after extending rearward. If correct geometry would hide the tail completely, hide it completely. Show only the naturally visible shell portion. Never move, rotate, enlarge or re-aim rear equipment for visibility. Keeping equipment in frame forbids cropping, not occlusion. Front readability comes from face, human silhouette, armor construction, colors and front-side components. Sheets document separate shell/tail roots in the rear view and equipment inset.\n\nFAIL CONDITIONS: A tail attached to the waist, hip side, flank, shoulder, arm or elbow; a spiral turned into a display disk; a shell shifted toward one flank for visibility; or altered framing, margins, pose or anatomy to expose rear equipment. Natural distal overlap beside a limb is not itself a mounting error.",
  "create": "Invent one distinctive, woman from the appearance settings below. Keep anatomy independent of equipment size. Explicit facial geometry takes priority over impression words and broad ethnicity cues.",
  "reference": "Use the SAME woman from the user-approved identity reference. The approved image is the stable identity anchor; a first draft is not automatically approved. Preserve facial geometry, age, ethnicity, eye shape and color including side assignment, nose, mouth, jaw, skin tone, hair color, hairstyle and length, height, build and body proportions. Expressions may change without changing facial structure; hair may move naturally without a haircut. Do not average identities or gradually replace the approved anchor with successive generated images. One approved reference image is sufficient. If an additional design image is supplied, it controls only the explicitly identified armor details, never a different face or body. Text appearance settings from the creation stage do not override reference identity. FRONT-VIEW ANATOMY AUTHORITY: for a multi-view identity sheet, use its main front full-body view as the authoritative body-proportion reference. Rear views and detail insets explain equipment, attachments and local details, not a competing body build. Do not average conflicting views or adopt a wider torso or pelvis from a rear perspective. Resolve contradictory skin/textile depictions of the SAME surface in favor of the main front view; a surface visible only from behind may legitimately have different coverage. Do not propagate rear-view fabric onto front-view skin merely to reconcile the sheet. An explicitly approved alternative anatomy reference overrides this default. For a single-image reference, preserve that image's anatomy. Account for perspective and pose when comparing proportions; do not copy literal pixel widths across different views.",
  ...
  "referenceForm": "Preserve attached design details where compatible with the selected form and MOUNT CORRECTION PRIORITY. Repair erroneous equipment placement without changing body proportions or pose. The identity sheet anchors the person, not the original armor thickness or silhouette when a DIFFERENT form is selected. FORM DEFINITION authorizes the selected armor transformation; style instructions about preserving armor prevent incidental redesign, not this requested form change. For overdrive with a separate base-form image, preserve that image's armor inventory and construction while opening it.",
  ...
  const REFERENCE_SHEET_PROFILE = {
    ...
    "camera": "One vertical 3:4 canvas. Align head and foot levels of both main views; keep head, feet and equipment within frame; allow natural equipment occlusion. Front view frontal or slightly three-quarter, rear view revealing back attachments; neutral standing poses. Keep figures prominent with restrained spacing; do not pull the camera back or shrink them for extra margins. Only the insets use close framing. For front or front-three-quarter comparison views, allow rear-equipment occlusion; never reposition it for visibility. Use one quiet background and consistent lighting in the chosen style, without action perspective or foreground occlusion.",
