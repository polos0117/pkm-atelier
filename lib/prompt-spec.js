...
(function (root) {
  ...
  "sourceMounts": "BODY-SPACE MOUNT LOCK: For existing/chosen equipment only; invent no extra appendages. Center the shell cradle on the spine; inner face against the back, dome rearward. A tail has an independent sacral root on the posterior pelvic midline below the shell, extending rearward before curling. Separate shell, tail and nozzle mounts. Never mount the tail on the side waist, hip plate, flank, shoulder, arm or elbow. The curl follows the tail in 3D, not a camera-facing disk. All forms change construction/articulation, but do not relocate the main mounts. Keep body-relative mounts, not screen coordinates; hidden roots imply no side mount. Only explicit user mounting instructions override this.\n\nREAR EQUIPMENT OCCLUSION LOCK: Preserve geometry with natural visibility/occlusion. In front or front-three-quarter views, keep posterior roots behind the torso and pelvis. Only distal tail portions may emerge after extending rearward. Natural lateral projection is allowed for shell rims and distal curls with coherent rearward connections. Do not delete, shrink or forcibly conceal signature equipment to fix mounting errors. Equipment follows torso/pelvis rotation; never shift or re-aim it independently for visibility. Keeping equipment in frame forbids cropping, not occlusion. Preserve established equipment size and identity through form changes; natural occlusion remains valid. Sheets document separate shell/tail roots in the rear view and equipment inset.\n\nFAIL CONDITIONS: A tail attached to the waist, hip side, flank, shoulder, arm or elbow; a spiral turned into a display disk; a shell shifted toward one flank for visibility; or changed framing/anatomy to expose equipment. Body turning follows CAMERA & PRESENTATION. Natural distal overlap beside a limb is not itself a mounting error.",
