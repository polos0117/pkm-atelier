...
(function (root) {
  ...
  "referenceActionRearPose": "Orientation (default for rear-mounted equipment): rear three-quarter view. The torso is turned about 120 degrees away from the camera so the near shoulder is closest, the face looks back over that shoulder toward the camera, the shell sits between the shoulder blades in full view and the tail extends behind the pelvis. The equipment is seen where it is mounted, so nothing needs to move.",
