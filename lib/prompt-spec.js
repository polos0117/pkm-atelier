...
(function (root) {
  ...
  const REFERENCE_SHEET_PROFILE = {
    ...
    "featureRule": "Dedicated close-up per line; show the named part and connection. Generic armor/full-body repeats do not count.",
    ...
    "negative": "INSET FIDELITY LOCK: Each inset magnifies its named installed component, never a new design. Match main-view silhouette, panels, colors, markings, channels, fasteners and mounts; finer detail may increase, structure may not. Plan details before views. Keep face, hair, anatomy, coverage and left/right identity identical. Each full body has two arms and two legs; appendages are equipment. If tailed, the rear three-quarter view and REAR MOUNTING SYSTEM inset must clearly show the tail's posterior attachment root at the sacrum, continuously connected, never front/side waist. No alternate faces/outfits, extra limbs, childlike proportions or text overlays.",
