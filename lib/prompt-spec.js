...
'traditional':'그 캐릭터의 계통에 맞는 전통 의상. 정장형과 현대화된 일상형 중에서 고른다. 고증을 지키되 색은 원본 포켓몬를 따를 수 있다.'};
  ...
  "negative": "One coherent adult human body with two arms and two legs; no duplicated hands, faces or accidental limbs. Source-derived appendages remain intentional design elements, not extra human limbs. Keep facial identity and anatomy independent of rendering stylization, outfit and armor volume. No childlike age regression, generic identity replacement, unintended collage, captions, logos or watermarks. Lighting, surfaces and edge treatment follow the selected style in every mode.",
