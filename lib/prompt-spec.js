...
'traditional':'그 캐릭터의 계통에 맞는 전통 의상. 정장형과 현대화된 일상형 중에서 고른다. 고증을 지키되 색은 원본 포켓몬를 따를 수 있다.'};
  ...
  "portraitCamera": "Full-body comparison portrait, vertical 2:3. Keep the whole silhouette, head and feet in frame with consistent margins. For subsequent form portraits match the approved comparison portrait's camera height, angle, focal length, subject scale, framing and background layout; allow only small natural pose and expression changes. If the identity reference is an action or casual image, establish a neutral front or slight three-quarter comparison view instead of inheriting its dynamic camera. Use a simple low-detail background appropriate to the selected style; bright or white backgrounds are allowed. Do not use a dramatic action camera, strong foreshortening or foreground occlusion.",
  ...
  "portrait": "PORTRAIT: generate one full-body comparison image showing the selected armor form clearly. Calm staging, legible layer boundaries, small pose variation and restrained effects.",
  ...
  root.AtelierSpec = {
    PROJECT_RULES, FORM_PROFILES, OUTPUT_PROFILES, IDENTITY_GROUPS, IDENTITY_EXCLUDED,
