...
'traditional':'그 캐릭터의 계통에 맞는 전통 의상. 정장형과 현대화된 일상형 중에서 고른다. 고증을 지키되 색은 원본 포켓몬를 따를 수 있다.'};
  ...
  const STYLE_PROFILES = {
    ...
    mecha_cinematic_keyart: {
      core: [
        "high-impact, illustration-first mecha promotional key art that combines a clearly adult anime-informed character with dense premium hard-surface mechanics.",
        ...
        "FACE: preserve the exact clearly adult identity, ethnicity, apparent age, facial structure, eye geometry, and facial character defined by CHARACTER IDENTITY. Translate that same face into crisp expressive anime-informed rendering with clean eyelid and lash shapes, a refined dimensional nose, softly defined lips, luminous eyes, and clear cheek, jaw, and chin modelling; never substitute a recurring doll face or generic glamour template.",
      ...
      lifestyle: [
        "Render the same adult identity with the style's crisp expressive anime-informed face, luminous illustrated skin, layered highlighted hair, saturated campaign-art colour, and coherent environmental light, but omit armor and combat effects unless the selected scene explicitly requests them.",
