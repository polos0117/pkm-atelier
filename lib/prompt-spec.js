...
'traditional':'그 캐릭터의 계통에 맞는 전통 의상. 정장형과 현대화된 일상형 중에서 고른다. 고증을 지키되 색은 원본 포켓몬를 따를 수 있다.'};
  ...
  const STYLE_PROFILES = {
    ...
    glossy_promo: {
      "core": "Premium anime-mecha promotional key art with clean linework, dense hard-surface mechanical detailing, strong dimensional shading, vivid but elegant colors, polished 2.5D character rendering, and a high-end campaign illustration finish. FACE: clearly adult anime facial design with expressive eyes, clean illustrated features and softly dimensional shading; preserve the selected or approved facial identity, age, ethnicity, hair and proportions. FINISH: crisp controlled linework and a clean silhouette, substantial painted volume and selective glossy highlights across body, hair and equipment. Avoid flat cel-only rendering, photographic skin and literal CGI or raw PBR presentation. LIGHT AND MATERIALS: strong dimensional lighting, coherent contact shadows and refined reflections; distinguish living skin, flexible fabric and rigid mechanical surfaces. Skin must not inherit metallic armor gloss. Vivid color remains elegant and faithful to the chosen palette. STYLE AUTHORITY: rendering never changes body thickness, armor coverage, equipment, pose or framing. Mechanical density means resolved construction, not extra plates or a larger body. Do not force a background, expression, dramatic perspective, shallow focus or combat effects; follow the selected scene and output mode. Reference sheets retain their required views, comparison portraits their full-body camera and scale, and casual scenes their everyday setting. TEXT AND GRAPHIC OVERLAYS: no typography, captions, numbers, labels, interface panels, logos, watermarks or decorative pseudo-writing. No unsolicited inset panels or promotional page layout.",
      "anthro": "Render the selected source-derived mechanical design with dense hard-surface detailing: thick readable edges where designed, purposeful panel seams, articulated joints, recessed fasteners, compact actuators and convincing attachment points. Preserve the selected form and source silhouette; detail does not authorize extra equipment, increased coverage or anatomical enlargement. Use broad dimensional planes and controlled glossy reflections to give existing armor convincing weight. Keep the human face visibly anime-designed while body and machinery share polished 2.5D shading and the same light field. Keep hands, feet, defining equipment and material boundaries readable. No textual decals or serial numbers.",
