...
(function (root) {
  ...
  "referenceActionOutput": "Create one dynamic full-body card illustration of the selected form. Keep one readable figure, a clear action silhouette and the form's defining equipment. Unless scene selections specify otherwise, use a vertical 2:3 frame, show head, feet and mounted equipment, and turn the face toward the camera in a front or three-quarter view.",
