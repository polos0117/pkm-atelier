...
(function (root) {
  ...
  "sourceDesignCreate": "SOURCE-TO-MECHANISM DESIGN: Start from a fresh design. CREATIVE ENGINEERING PREPASS: Receiving assistant: before one image call, put a canonical design record in the prompt, not on canvas. Resolve presence: user choices first, then species-specific choices. Optional is not absent by default. Distinguish core equipment and form-specific armor parts; record selected/absent separately from mounted/stowed and visible/occluded. Hidden or stowed does not mean absent. Combine biology/silhouette and elemental type into one original functional signature mechanism and up to one restrained surface detail on a named existing component. Define function, shape, materials, colors/markings and anatomically correct body-space mounts before layout. Reuse it across views with bilateral armor symmetry. No unrelated equipment, core presence/anatomy/form changes or fixed species templates. Include the concise design record with the result for reuse; provisional until approved.",
